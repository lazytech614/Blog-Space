...
export const WarningModal = ({ isOpenWarningModal, setIsOpenWarningModal, onConfirmDelete }) => {
    useEffect(() => {
        if (document) {
    ...
    return createPortal(
        <div className='fixed inset-0 z-[100] flex items-center justify-center'>
            ...
            <div className='bg-white p-6 rounded-md z-[101]'>
                <p className='text-center mb-4'>Are you sure you want to cancel the subscription?</p>
