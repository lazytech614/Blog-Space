...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col md:gap-4 items-center'>
        ...
        <form onSubmit={handleSubmit} className='relative w-[70%] sm:w-[60%] md:w-[500px] h-[32px] sm:h-[40px] md:h-[60px] mx-auto bg-[#FFFFFF] flex justify-between items-center border border-black shadow-[-7px_7px_0px_#000000] rounded-md mt-4 md:mt-6 overflow-hidden duration-200'>
            <input
                type="text" 
                name='email'
